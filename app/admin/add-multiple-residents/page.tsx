...
function TableStep({
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    console.log(parsedRows[0].data);
    try {
      const res = await apiFetch("api/admin/seed-residents", {
        method: "POST",
  ...
  return (
    <div className="w-full h-dvh flex flex-col p-4 gap-3">
      ...
      <div className="flex-1 min-h-0 bg-accent rounded-sm border overflow-hidden">
