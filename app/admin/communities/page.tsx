      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {communities.map((c) => (
            ...
            >
              <Card className="hover:md:border-unset md:border-0 md:rounded-none md:shadow-sm md:border-b md:border-b-primary/30 hover:border-primary/30 transition-colors py-2">
