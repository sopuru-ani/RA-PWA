...
import { useSAWorkspace } from "@/context/SAWorkspaceContext";
import Empty from "@/components/RA/Empty";
import { ShieldAlert } from "lucide-react";

export default function SAIncidentsPage() {
    ...
    <div className="flex flex-col h-full mx-3">
      <div className="mb-2">
        ...
        <p className="text-sm text-muted-foreground mx-1">
          Reports you submitted in your community
        </p>
      </div>
      ...
      {filteredIncidents.length === 0 ? (
        <Empty
          ...
          description="Incidents you file will appear here."
                  ...
                  <AccordionItem value="item-1" className="border-none">
                    <AccordionTrigger className="hover:no-underline py-2">
                      <div className="flex w-full justify-between gap-2 text-left">
                        ...
                        <span
                          className={
                            "text-xs px-2 py-0.5 h-fit shrink-0 rounded-full " +
                            (incident.resolved
