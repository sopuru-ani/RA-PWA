    ...
    <div className="min-h-dvh flex flex-col bg-background relative overflow-hidden">
      ...
      <header className="relative z-10 p-4 sm:p-6">
        <Link href="/" className="inline-flex items-center gap-3 group">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl border-2 border-foreground/10 bg-background/50 backdrop-blur-sm p-1.5 shadow-sm group-hover:border-primary/30 transition-colors">
            <Logo className="w-full h-full text-foreground" />
          </div>
          <span className="text-xl sm:text-2xl font-bold tracking-tight group-hover:text-primary transition-colors">
            Domus
          </span>
        </Link>
      </header>
