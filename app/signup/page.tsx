...
function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center p-4 min-h-dvh positive-relative">
      <div className="flex flex-row gap-3 items-center p-3 bg-primary w-dvw absolute top-0 left-0">
        ...
        <h1 className="text-3xl font-bold tracking-tight inline text-white">
          Domus
        </h1>
      </div>
      ...
      <footer className="bg-primary text-white p-6 px-4 mt-10 shadow-inner absolute bottom-0 w-full">
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          {/* <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-black shadow-md border border-gray-200">
              <svg
                viewBox="0 0 1024 1024"
                className="w-6 h-6"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  fill="currentColor"
                  strokeWidth="2.0282"
                  d="M218.475,869.746 ... (same path as your logo)"
                />
              </svg>
            </div>
            <span className="font-bold text-lg">Domus</span>
          </div> */}

          {/* Copyright text */}
          <p className="text-sm sm:text-base">
            &copy; 2026 Domus. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
